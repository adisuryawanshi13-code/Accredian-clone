...
import { ENTERPRISE_NAV_ITEMS, NAVIGATION_SECTION_IDS } from "@/shared/constants/navigation.constants";
...
export const Navbar: React.FC<NavbarProps> = () => {
  ...
  const { activeSection, scrollToSection } = useActiveSection(NAVIGATION_SECTION_IDS);
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          {/* Accredian Logo matching Screenshots */}
          <Link
            href="/"
